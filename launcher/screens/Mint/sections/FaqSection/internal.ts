...
export const faqList: FaqItemConfig[] = [
	{
		title: 'How to buy?',
		content: [
			'Step 1: Access [Under Realm Minting page](https://underrealm.stormgate.io/mint)',
	...
	},
	{
		...
		content: [
			'We are still working on Under Realm: Rise of Magic and aiming for Alpha go live by Q4, 2022. You can subscribe to be on the Alpha waiting list [here](https://stormgate.io/alpha-sign-up) and be the first to learn about and play Under Realm before everyone else. Limited slots available only! ',
		],
	},
	{
		title: 'Can I sell my card?',
		content: [
			'Yes, we are working on our own marketplace. We will be also available on Secondary marketplace including [Magic Eden](https://magiceden.io/drops/underrealm), Opensea (to be update). ',
		],
	},
	{
		...
		content: [
			'',
			'- Build deck and battle in Under Realm',
	...
	},
	{
		...
		content: [
			'Yes, you can. There is 2 ways to do so:',
			'',
